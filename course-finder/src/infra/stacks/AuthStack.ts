...
export class AuthStack extends Stack {
    ...
    private createUserPool(){
        this.userPool = new UserPool(this, 'CourseUserPool', {
        ...
        new CfnOutput(this, 'CourseUserPoolId', {
            value: this.userPool.userPoolId
        })
    }
    private createUserPoolClient(){
        this.userPoolClient = this.userPool.addClient('CourseUserPoolClient', {
            authFlows: {
        ...
        new CfnOutput(this, 'CourseUserPoolClientId', {
            value: this.userPoolClient.userPoolClientId
        })
    }

    private createAdminsGroup(){
        new CfnUserPoolGroup(this, 'CourseAdmins', {
    ...
    private createIdentityPool(){
        this.identityPool = new CfnIdentityPool(this, 'CourseIdentityPool', {
        ...
        new CfnOutput(this, 'CourseIdentityPoolId', {
